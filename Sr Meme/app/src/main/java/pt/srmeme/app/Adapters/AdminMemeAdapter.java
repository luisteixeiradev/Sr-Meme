...
public class AdminMemeAdapter extends FirestoreRecyclerAdapter<Meme, AdminMemeAdapter.MemeHolder>  {
    ...
    public AdminMemeAdapter(@NonNull FirestoreRecyclerOptions<Meme> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final AdminMemeAdapter.MemeHolder holder, int i, @NonNull final Meme model) {
        Log.d("TEST_ADMIN", "onBindViewHolder: memeAdapter"+ model.getImage());
        ...
        holder.iconMenu.setImageResource(R.drawable.ic_more_vert_black_24dp);
        ...
        holder.iconLikes.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (user != null) {
                    ...
                    MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(holder.iconLikes.getContext());
                    ...
                    builder.setPositiveButton("Iniciar Sessão",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Context context = holder.iconLikes.getContext();
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    if (userStatus.equals("admin") || user.getUid().equals(model.getUser())) {
                                        ...
                                        builder.setTitle("O que queres fazer?");
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                db.collection("memes").document(model.getMeme_id()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        db.collection("reported_memes").document(model.getMeme_id()).delete();
                                        ...
                                        builder.setNegativeButton("Remover Denúncia",new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
    ...
    @NonNull
    @Override
    public AdminMemeAdapter.MemeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.meme_card,
                parent, false);

        return new AdminMemeAdapter.MemeHolder(v);
    }
