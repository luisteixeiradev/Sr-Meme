...
public class MemeByCategoriesAdapter extends FirestoreRecyclerAdapter<Meme, MemeByCategoriesAdapter.MemeHolder>  {
    String usernameFB;
    String profileImgFB;
    String likeUserId;
    ...
    public MemeByCategoriesAdapter(@NonNull FirestoreRecyclerOptions<Meme> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final MemeByCategoriesAdapter.MemeHolder holder, int i, @NonNull final Meme model) {
        Log.d("TEST", "onBindViewHolder: memeAdapter");
                ...
                if (user != null) {
                    ...
                    builder.setPositiveButton("Iniciar Sessão",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent goToLogin = new Intent(context, Login.class);
                            goToLogin.putExtra("keyMemesByCategory", 1);
                            context.startActivity(goToLogin);
                            MemesByCategories.fa.finish();
                        }
                    });
                    builder.show();
                }
